...
#include "ue5_vehicle_testWheelFront.h"
#include "ue5_vehicle_testWheelRear.h"
...
const FName Aue5_vehicle_testPawn::LookUpBinding("LookUp");
const FName Aue5_vehicle_testPawn::LookRightBinding("LookRight");
const FName Aue5_vehicle_testPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

Aue5_vehicle_testPawn::Aue5_vehicle_testPawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = Uue5_vehicle_testWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = Uue5_vehicle_testWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = Uue5_vehicle_testWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = Uue5_vehicle_testWheelRear::StaticClass();
...
void Aue5_vehicle_testPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &Aue5_vehicle_testPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &Aue5_vehicle_testPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &Aue5_vehicle_testPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &Aue5_vehicle_testPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &Aue5_vehicle_testPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &Aue5_vehicle_testPawn::OnResetVR); 
}

void Aue5_vehicle_testPawn::MoveForward(float Val)
{
	if (Val >= 0)
	{
...
void Aue5_vehicle_testPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void Aue5_vehicle_testPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void Aue5_vehicle_testPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void Aue5_vehicle_testPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void Aue5_vehicle_testPawn::EnableIncarView(const bool bState)
{
...
void Aue5_vehicle_testPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void Aue5_vehicle_testPawn::BeginPlay()
{
	Super::BeginPlay();
...
void Aue5_vehicle_testPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void Aue5_vehicle_testPawn::UpdateHUDStrings()
{
...
void Aue5_vehicle_testPawn::SetupInCarHUD()
{
...
void Aue5_vehicle_testPawn::UpdatePhysicsMaterial()
{
