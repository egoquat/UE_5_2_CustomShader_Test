...
AUE_CustomShader_TestHud::AUE_CustomShader_TestHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AUE_CustomShader_TestHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if( bHMDDeviceActive == false )
	{
		...
		AUE_CustomShader_TestPawn* Vehicle = Cast<AUE_CustomShader_TestPawn>(GetOwningPawn());
