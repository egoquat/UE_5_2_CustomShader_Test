...
#include "UE_CustomShader_TestWheelFront.h"
#include "UE_CustomShader_TestWheelRear.h"
...
const FName AUE_CustomShader_TestPawn::LookUpBinding("LookUp");
const FName AUE_CustomShader_TestPawn::LookRightBinding("LookRight");
const FName AUE_CustomShader_TestPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

AUE_CustomShader_TestPawn::AUE_CustomShader_TestPawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = UUE_CustomShader_TestWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = UUE_CustomShader_TestWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = UUE_CustomShader_TestWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = UUE_CustomShader_TestWheelRear::StaticClass();
...
void AUE_CustomShader_TestPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUE_CustomShader_TestPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUE_CustomShader_TestPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AUE_CustomShader_TestPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AUE_CustomShader_TestPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AUE_CustomShader_TestPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AUE_CustomShader_TestPawn::OnResetVR); 
}

void AUE_CustomShader_TestPawn::MoveForward(float Val)
{
	if (Val >= 0)
	{
...
void AUE_CustomShader_TestPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AUE_CustomShader_TestPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AUE_CustomShader_TestPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AUE_CustomShader_TestPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AUE_CustomShader_TestPawn::EnableIncarView(const bool bState)
{
...
void AUE_CustomShader_TestPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AUE_CustomShader_TestPawn::BeginPlay()
{
	Super::BeginPlay();
	...
	UTextureRenderTarget2D* rtRaycastCustom = Cast<UTextureRenderTarget2D>(
	StaticLoadObject(UTextureRenderTarget2D::StaticClass(), this,
		TEXT("/Script/Engine.TextureRenderTarget2D'/CustomShader/CustomShaderMaterial/RT_CustomTest01.RT_CustomTest01'")));

	ensure(rtRaycastCustom);
	UWorld* world = GetWorld();
	ACustomShaderRunner* raycastRunner = world->SpawnActorDeferred<ACustomShaderRunner>(
		ACustomShaderRunner::StaticClass(),
		GetTransform(),
		this);
	raycastRunner->RTRaycast = rtRaycastCustom;
	raycastRunner->AttachToActor(this, FAttachmentTransformRules::KeepWorldTransform);
}

void AUE_CustomShader_TestPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AUE_CustomShader_TestPawn::UpdateHUDStrings()
{
...
void AUE_CustomShader_TestPawn::SetupInCarHUD()
{
...
void AUE_CustomShader_TestPawn::UpdatePhysicsMaterial()
{
